		...
		<div className="border-2 bg-neutral-100 absolute rounded-lg shadow-md right-24 w-64 flex items-center space-x-1">
			...
			{modalState.loading &&
				<div className="flex space-x-2 justify-center items-center">
					<div className="inline-block h-6 w-6 animate-spin rounded-full border-4 border-solid border-current 
						border-e-transparent align-[-0.125em] text-surface motion-reduce:animate-[spin_1.5s_linear_infinite] text-stone-700"
						role="status" />
